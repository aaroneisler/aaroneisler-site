      ...
      <section className="relative px-6 lg:px-8" style={{ paddingTop: '2.618rem', paddingBottom: '2.618rem' }}>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="hidden md:block" style={{ position: 'relative', height: '280px' }}>
            ...
            {/* Top: Articles - positioned on ellipse (y = -150px from center) */}
            <div style={{ position: 'absolute', top: 'calc(50% - 150px)', left: '50%', transform: 'translate(-50%, -50%)', zIndex: 1 }}>
            ...
            {/* Left: LinkedIn - positioned on ellipse (x = -350px from center) */}
            <div style={{ position: 'absolute', top: '50%', left: 'calc(50% - 350px)', transform: 'translate(-50%, -50%)', zIndex: 1 }}>
            ...
            {/* Right: AI Agents - positioned on ellipse (x = +350px from center) */}
            <div style={{ position: 'absolute', top: '50%', left: 'calc(50% + 350px)', transform: 'translate(-50%, -50%)', zIndex: 1 }}>
            ...
            {/* Bottom: Resume - positioned on ellipse (y = +150px from center) */}
            <div style={{ position: 'absolute', top: 'calc(50% + 150px)', left: '50%', transform: 'translate(-50%, -50%)', zIndex: 1 }}>
