      ...
      <section className="relative px-6 lg:px-8" style={{ paddingTop: '2.618rem', paddingBottom: '2.618rem' }}>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="hidden md:block" style={{ position: 'relative', height: '280px' }}>
            ...
            {/* Left: LinkedIn */}
            <div style={{ position: 'absolute', top: '50%', left: '10%', transform: 'translateY(-50%)', zIndex: 1 }}>
            ...
            {/* Right: AI Agents */}
            <div style={{ position: 'absolute', top: '50%', right: '10%', transform: 'translateY(-50%)', zIndex: 1 }}>
