      ...
      <section className="relative px-6 lg:px-8" style={{ paddingTop: '2.618rem', paddingBottom: '2.618rem' }}>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="hidden md:block" style={{ position: 'relative', height: '280px' }}>
            {/* Connecting ellipse through all pills - golden ratio (horizontal/vertical = φ) */}
            <div style={{
              position: 'absolute',
              top: '50%',
              left: '50%',
            ...
            {/* Top: Articles - positioned on ellipse (y = -136px from center) */}
            <div style={{ position: 'absolute', top: 'calc(50% - 136px)', left: '50%', transform: 'translate(-50%, -50%)', zIndex: 1 }}>
              <a href="https://www.linkedin.com/in/aaroneisler/recent-activity/articles/" target="_blank" rel="noopener noreferrer" className="font-medium flex items-center justify-center gap-2 transition-all hover:scale-[1.02] active:scale-[0.98] hover-accent" style={{ padding: '0.786em 1.618em', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', background: 'var(--surface)' }}>
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" /></svg>
                Articles
              </a>
            </div>
            {/* Left: LinkedIn - positioned on ellipse (x = -220px from center) */}
            <div style={{ position: 'absolute', top: '50%', left: 'calc(50% - 220px)', transform: 'translate(-50%, -50%)', zIndex: 1 }}>
              <a href={profile.linkedin} target="_blank" rel="noopener noreferrer" className="font-medium flex items-center justify-center gap-2 transition-all hover:scale-[1.02] active:scale-[0.98] hover-accent" style={{ padding: '0.786em 1.618em', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', background: 'var(--surface)' }}>
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>
                LinkedIn
              </a>
            </div>
            {/* Right: AI Agents - positioned on ellipse (x = +220px from center) */}
            <div style={{ position: 'absolute', top: '50%', left: 'calc(50% + 220px)', transform: 'translate(-50%, -50%)', zIndex: 1 }}>
              <a href="https://github.com/aaroneisler?tab=repositories" target="_blank" rel="noopener noreferrer" className="font-medium flex items-center justify-center gap-2 transition-all hover:scale-[1.02] active:scale-[0.98] hover-accent" style={{ padding: '0.786em 1.618em', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', background: 'var(--surface)' }}>
            ...
            {/* Bottom: Resume - positioned on ellipse (y = +136px from center) */}
            <div style={{ position: 'absolute', top: 'calc(50% + 136px)', left: '50%', transform: 'translate(-50%, -50%)', zIndex: 1 }}>
              <a href="/resume" className="font-medium flex items-center justify-center gap-2 transition-all hover:scale-[1.02] active:scale-[0.98] hover-accent" style={{ padding: '0.786em 1.618em', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', background: 'var(--surface)' }}>
          ...
          <div className="md:hidden flex flex-col items-center" style={{ gap: 'var(--space-md)' }}>
            <button
              onClick={() => setIsChatOpen(true)}
              className="font-medium flex items-center justify-center gap-2 transition-all hover:scale-[1.02] active:scale-[0.98] rainbow-border"
              style={{ padding: '1.272em 2.618em', background: '#1a1a2e', color: '#ffffff', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-md)' }}
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /></svg>
              Ask AI About Me
            </button>
            <div className="flex flex-wrap justify-center" style={{ gap: 'var(--space-sm)' }}>
              <a href={profile.linkedin} target="_blank" rel="noopener noreferrer" className="font-medium flex items-center gap-2 transition-all hover:scale-[1.02] hover-accent" style={{ padding: '0.618em 1em', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', background: 'var(--surface)', fontSize: 'var(--text-sm)' }}>LinkedIn</a>
              <a href="https://www.linkedin.com/in/aaroneisler/recent-activity/articles/" target="_blank" rel="noopener noreferrer" className="font-medium flex items-center gap-2 transition-all hover:scale-[1.02] hover-accent" style={{ padding: '0.618em 1em', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', background: 'var(--surface)', fontSize: 'var(--text-sm)' }}>Articles</a>
              <a href="https://github.com/aaroneisler?tab=repositories" target="_blank" rel="noopener noreferrer" className="font-medium flex items-center gap-2 transition-all hover:scale-[1.02] hover-accent" style={{ padding: '0.618em 1em', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', background: 'var(--surface)', fontSize: 'var(--text-sm)' }}>AI Agents</a>
              <a href="/resume" className="font-medium flex items-center gap-2 transition-all hover:scale-[1.02] hover-accent" style={{ padding: '0.618em 1em', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', background: 'var(--surface)', fontSize: 'var(--text-sm)' }}>Resume</a>
            </div>
          </div>
        </div>
      </section>
