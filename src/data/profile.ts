...
export const experience = [
  {
    ...
    aiContext: {
      situation: "Orro was being killed by its own success. They'd just landed Australia Post and QANTAS. Enterprise-scale customers. Problem was, Orro wasn't an enterprise-scale company. It was 11 smaller companies stitched together through acquisition. Four networking companies, two cyber, several cloud. Different systems, different cultures, very little operational maturity. Now they had to deliver for customers who expected big-company reliability from what was still a collection of small companies figuring out how to work together.",
      approach: "I didn't start with a transformation roadmap. I started by sitting with the teams who were drowning. The ones quoting work we couldn't deliver profitably. The ones missing SLAs. The ones finding billing errors months after the fact. Fixed the leaks first. Built automation to catch revenue leakage and contract risk. Then standardised the operating model piece by piece. Some teams came willingly. Some needed convincing. A few needed replacing.",
      results: "2% EBITDA improvement in under two years. QANTAS, Jetstar, Flight Centre, Australia Post renewed. These were relationships that were on the edge when I arrived. AI tools now catch the problems before customers do. The business can finally quote, win, and deliver at enterprise scale.",
  ...
  },
  {
    ...
    aiContext: {
      situation: "I joined Telstra as a consulting manager and left seven years later running platforms for the enterprise business. Four different roles. Each one came because I fixed something that was broken. CBA was struggling. Defence was at risk. National delivery was missing targets. These weren't promotions handed out. They were problems nobody else wanted.",
      approach: "The CBA and Defence accounts were my first test. Big relationships, unhappy clients. I moved in, understood what was actually failing, and rebuilt trust through delivery. When that worked, they promoted me to build their automation and robotics practice. This was the most important strategic bet Telstra was making. No team, no platform, no clients. I wrote the strategy and roadmap, then executed it. Built the framework, hired the people, created the commercial model, sold the first deals myself. That practice became the foundation for Telstra's AI partnership with Accenture.",
      results: "Rapid automation platform delivered $12M value in year one. All Big 4 banks signed up. Australia's first Arista SDN ($27M) won and delivered. CBA, Westpac, Defence renewed. Wireless practice hit $3.6M pipeline in year one. 106% utilisation across the team. The automation practice I built paved the way for Telstra's broader AI strategy.",
